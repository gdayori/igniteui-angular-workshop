...
@Component({
  selector: 'app-monstergrid',
  templateUrl: './monstergrid.component.html',
  styleUrls: ['./monstergrid.component.scss']
})
export class MonsterGridComponent implements OnInit, AfterViewInit {
